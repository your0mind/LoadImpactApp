...
namespace LoadImpactApp.ResultsSettings
{
    public  class MetricSettingsTableBase : TableLayoutPanel
    {
        ...
        public MetricSettingsTableBase()
        {
            ...
            ColumnCount = 4;
            ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 210f));
            ...
            Controls.Add(new Label { Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleCenter, Text = "Look for stability" }, 1, 0);
            Controls.Add(new Label { Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleCenter, Text = "Arithmetic precision" }, 2, 0);
        ...
        public List<MetricSettings> GetMetricsSettings()
        {
            ...
            for (int i = 1; i < RowCount - 1; i++)
            {
                metricsSettings.Add(new MetricSettings
                {
                    ...
                    Smoothed = ((CheckBox)GetControlFromPosition(1, i)).Checked,
                    Precision = (int)((NumericUpDown)GetControlFromPosition(2, i)).Value
                });
            }
        ...
        protected void AddDefaultControlsForSettings(MetricSettings metricSettings)
        {
            ...
            Controls.Add(new CheckBox { Dock = DockStyle.Fill, CheckAlign = ContentAlignment.MiddleCenter, Checked = metricSettings.Smoothed }, 1, RowCount - 2);
            Controls.Add(new NumericUpDown { Value = metricSettings.Precision, Font = new Font("Microsoft Sans Serif", 10), Maximum = 5 }, 2, RowCount - 2);
