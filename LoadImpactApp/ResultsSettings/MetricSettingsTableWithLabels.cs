...
{
    internal sealed class MetricSettingsTableWithLabels : MetricSettingsTable
    {
        ...
        {
            /////////////////////////////////////////////////////////////
            var addMetricForm = new AddMetricFormWithComboBox(m_Metrics);
        ...
        private void AddMetricForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                Name = (AddMetricFormWithComboBox)sender.
            });
        }
